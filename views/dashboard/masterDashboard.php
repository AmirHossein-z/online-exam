    ...
    <nav
      ...
      <div
        ...
        <div
          ...
          <ul class="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
            <li class="items-center">
              <a href="../landing.html" class="text-red-500 text-xs uppercase py-3 font-bold block">
                <i class="fa-solid fa-arrow-right-from-bracket mr-2 text-sm"></i>
                خروج
              </a>
            </li>
          </ul>
    ...
    <div class="relative md:ml-64 bg-blueGray-50">
      <nav
        ...
        <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
          <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="./index.html">داشبورد</a>
